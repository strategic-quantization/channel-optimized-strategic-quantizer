...
% xminit(1,:,:)=[a*ones(length(thval),1) sort(-3+(6)*rand(length(thval),M-1)')' b*ones(length(thval),1)];
for r=2:7
...
options = optimoptions('fmincon','MaxFunctionEvaluations',90000000,'MaxIterations',90000000,'SpecifyObjectiveGradient',true,'Display','off');
tic
